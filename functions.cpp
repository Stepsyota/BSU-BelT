...
unsigned int G_func(unsigned int word, unsigned int r) {
...
unsigned int ShLo(unsigned int word) {
    return word / 2;
}
unsigned int ShHi(unsigned int word) {
    return word * 2;
}
unsigned int RotHi(unsigned int word) {
...
unsigned int H_func(unsigned int word) {
